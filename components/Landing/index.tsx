...
export default function Home() {
  ...
  return (
    <motion.main variants={slideUp} initial="initial" animate="enter" className={styles.landing} style={{ backgroundColor: '#141516' }}>
      ...
      <div data-scroll data-scroll-speed={0.1} className={styles.description}>
        ...
        <p>Frontend Specialist & Full-Stack Builder</p>
      </div>
    </motion.main>
  )
}
